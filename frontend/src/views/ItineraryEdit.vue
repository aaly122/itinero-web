...
<template>
    <div class="h-[100dvh] w-screen bg-slate-50 ">
        <div class="w-[30%] h-full bg-transparent md:ml-20 p-4 ">
            <div class="w-full h-full bg-white rounded-xl shadow-2xl flex flex-col p-2  ">
                <div id="lowerBox" class="h-full bg-slate-100 rounded-xl flex flex-col p-2 gap-2 overflow-y-scroll">
                    ...
                    <div v-for="value in numbers" class="w-full min-h-55 rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.2)] p-4 grid grid-cols-4 grid-rows-5 border-b-8 cursor-pointer transition-all ease-in">
                        ...
                        <div class="p-2 h-10 text-xs bg-primary-200 rounded-full col-start-4 row-span-1 flex justify-center items-center">
                            <p class="font-bold text-white">Tag</p>
                        </div>
                        <p class="row-start-3 col-span-4 row-span-2 text-slate-700 italic text-md overflow-hidden">Address</p>
                        <p class="row-start-5 text-slate-700 w-5">Arrival Time</p>
                        <p class="row-start-5 text-slate-700 w-5">Departure Time</p>
                        <p class="row-start-5 col-start-3 col-span-2">N meters from last stop</p>
                    </div>
