...
<template>
  <div class="min-h-[300dvh] w-full flex flex-col bg-pink-50 overflow-x-hidden">
    ...
    <div class="min-h-screen w-full p-4 md:p-10 flex flex-col justify-center items-center bg-[url('@/assets/imgs/IMG_6906.jpg')] md:bg-[url('@/assets/imgs/IMG_8186.jpg')] bg-cover bg-fixed">
      ...
      <Button label="Create Itinerary" rounded raised class=" w-55 transition-all ease-in-out duration-250 hover:scale-115 hover:bg-primary-50 hover:text-black border-0"></Button>
    </div>
    ...
    <div class="md:block flex flex-col gap-2">
      <div class="h-10 w-full bg-primary-600"></div>
      <div class="h-[100dvh] md:h-[70dvh] w-full p-10 md:p-25 md:grid grid-cols-2 grid-rows-3 gap-5 bg-primary-700">
          <div class="font-[Poppins] text-4xl text-yellow-500 font-bold col-span-1 self-end md:text-left text-center ">See the History You Care About.</div>
          <div class="row-start-2 col-start-1 text-justify text-white">
      ...
      <div class="h-[100dvh] md:h-[70dvh] w-full p-10 md:p-25 md:grid grid-cols-2 grid-rows-3 gap-5 bg-primary-600">
      ...
      <div class="h-[100dvh] md:h-[70dvh] w-full p-10 md:p-25 md:grid grid-cols-2 grid-rows-3 gap-5">
    ...
    <div class="h-[50dvh] w-full bg-primary-200"></div>
